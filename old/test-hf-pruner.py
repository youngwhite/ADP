...
parser.add_argument('--pruning_ratio', default=0.9, type=float, help='prune ratio')
...
unwrapped_parameters = [
    (model.vit.embeddings.cls_token, 0),
    (model.vit.embeddings.position_embeddings, 0)
    ]
...
print(f"--Base Param: {base_params/1e6:.2f}M, Macs: {base_macs/1e9:.2f}G")
print(f"--Pruned Param: {pruned_params/1e6:.2f}M, Macs: {pruned_macs/1e9:.2f}G")
